    ...
    <div className="inline-flex bg-[#c6c6ca] p-2 rounded-md gap-1">
      <button
        ...
        className={`flex items-center gap-2 px-4 py-1.5 text-sm rounded-md transition-colors ${
          selected === "Rent" ? "bg-white text-[#7C3AED] shadow-sm" : "text-gray-600 hover:text-gray-900"
        }`}
      >
      ...
      <button
        ...
        className={`flex items-center gap-2 px-4 py-1.5 text-sm rounded-md transition-colors ${
          selected === "Buy" ? "bg-white text-[#7C3AED] shadow-sm" : "text-gray-600 hover:text-gray-900"
        }`}
      >
      ...
      <button
        ...
        className={`flex items-center gap-2 px-4 py-1.5 text-sm rounded-md transition-colors ${
          selected === "Sell" ? "bg-white text-[#7C3AED] shadow-sm" : "text-gray-600 hover:text-gray-900"
        }`}
      >
